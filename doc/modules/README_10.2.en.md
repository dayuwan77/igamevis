...
**Gradient (new `AdvancedGradientFilter`)**:

- Supports surface meshes, volume meshes, structured meshes, mixed 2D+3D meshes and polyhedral meshes;
- Scalar input → 3-component gradient vector;
- Vector input → 9-component gradient tensor;
- Supports point-data or cell-data output;
- Output attribute name is always `gradient_<source attribute>`;
- GUI defaults to point-data output and displays magnitude, not x / g0.
